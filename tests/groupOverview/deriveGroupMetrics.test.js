...
describe('deriveGroupMetrics site risk score handling', () => {
    ...
    test('sets siteRiskScore when metric exists in results', () => {
        ...
        const result = deriveGroupMetrics(mockGroupMetadata, mockResults, mockConfig);
    ...
    test('does not set siteRiskScore for non-Site GroupLevel', () => {
        ...
        const countryGroupMetadata = [
            ...
            { GroupLevel: 'Country', GroupID: 'Canada', Param: 'ParticipantCount', Value: '50' }
        ];
        ...
        const result = deriveGroupMetrics(countryGroupMetadata, mockResults, nonSiteConfig);
    ...
    test('correctly parses site risk score as float', () => {
        const mockResults = [
            { GroupID: 'Site001', MetricID: 'srs0001', Flag: 1, Score: '85.75' }
        ];
